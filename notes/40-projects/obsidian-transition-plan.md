...
Phase 1: private vault remains the main source.
...
The transition is by knowledge class, not by folder copy.
...
- external research
- project design safe for deployment
